...
<ul>
  <li><a href="{{staticPath}}/Capability">One page per type</a></li>
...
<ul>
  <li><a href="{{staticPath}}/Property">Property</a></li>
  <li><a href="{{staticPath}}/Action">Action</a></li>
  <li><a href="{{staticPath}}/Event">Event</a></li>
  <li><a href="{{staticPath}}/TemperatureData">TemperatureData</a>, <a href="{{staticPath}}/StateData">StateData</a>, <a href="{{staticPath}}/WindData">WindData</a> ...</li>
</ul>
